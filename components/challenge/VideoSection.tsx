    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-[var(--card-border)] rounded-2xl overflow-hidden">
        ...
        >
          ...
          <svg
            className={`w-4 h-4 text-[var(--text-muted)] transition-transform ${libraryOpen ? 'rotate-180' : ''}`}
        ...
        {libraryOpen && (
          <div className="px-4 pb-4 space-y-6 border-t border-[var(--card-border)] pt-4">
            {modules.map(m => (
