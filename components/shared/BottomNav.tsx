        ...
        {TABS.map(tab => {
          ...
          return (
            <Link
              key={tab.id}
              href={tab.href}
              className={`flex flex-col items-center gap-1 px-3 py-2 rounded-xl transition-colors min-w-0 min-h-[44px] justify-center ${isActive ? 'text-blue-800' : 'text-slate-400'}`}
            >
              <Icon />
